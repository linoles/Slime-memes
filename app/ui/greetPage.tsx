...
export default function GreetPage() {
  return (
    <Link
      ...
      className="flex flex-col items-center justify-center w-full h-fit left-appearence-trans cursor-pointer relative top-1/3"
    >
      <div className="flex flex-col items-center justify-center w-full h-full left-appearence-trans cursor-pointer">
        ...
        <h2
          className={`${inter.className} lg:text-4xl mg:text-3xl sm:text-2xl text-gray-700 font-medium text-center`}
        >
